...
INSERT INTO DIDACTYPO.SOUS_COURS (id_cours_parent,contenu_cours) VALUES (1,E'Super, reste dans cette position pour le reste du cours. (Si c"est trop difficile, fais une petite pause.)\n
...
E'Maintenant, il est temps de mettre tes mains en bonne position. Pose tes index sur les touches F et J ; elles ont de petites bosses pour t"aider ;)\n
...
INSERT INTO DIDACTYPO.SOUS_COURS (id_cours_parent,contenu_cours,chemin_img_sous_cours) VALUES (1,E'Bon travail ! L"étape la plus dure est terminée.\n
...
INSERT INTO DIDACTYPO.SOUS_COURS (id_cours_parent,titre_sous_cours,contenu_cours) VALUES (1,'Exercice','Maintenant, nous allons faire un petit exercice pour que tu puisses t"entraîner à bien écrire.');
